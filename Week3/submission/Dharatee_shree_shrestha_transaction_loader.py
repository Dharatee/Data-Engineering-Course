...
def load_batch(conn, rows: list) -> int:
    ...
    try:
        ...
        conn.rollback()
        logger.exception("Failed loading batch at row %s: %s", row_num, exc)
        raise
...
""""
2026-07-02 21:51:38,753  INFO  Trips before any load: 5,000
2026-07-02 21:51:38,753  INFO  --- Test 1: loading good batch (expect success) ---
2026-07-02 21:51:38,761  INFO  Test 1 passed: 5 rows loaded
2026-07-02 21:51:38,761  INFO  --- Test 2: loading bad batch (expect rollback) ---
2026-07-02 21:51:38,762  ERROR  Failed loading batch at row 3: numeric field overflow
DETAIL:  A field with precision 2, scale 1 must round to an absolute value less than 10^1.
2026-07-02 21:51:38,763  INFO  Test 2 passed: exception raised after rollback
2026-07-02 21:51:38,764  INFO  Trips after both tests: 5,005
2026-07-02 21:51:38,764  INFO  Net rows added: 5
"""