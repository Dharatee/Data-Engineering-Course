...
------------------------ create dim_vehicle and dim_location tables -------------------------------
---------------------------------------------------------------------------------------------------
...
CREATE TABLE fact_trips (
    ...
    vehicle_key             INTEGER         REFERENCES dim_vehicle(vehicle_key),    ------------vehicle_key added
    time_key                INTEGER         NOT NULL REFERENCES dim_time(time_key), ------------time_key addeed
